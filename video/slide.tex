    ...
    \begin{table}
        ...
        \begin{tabular}{|c|c|c|c|}
            \hline
             & MSE & PSNR & MSSSIM \\
             \hline
            Baseline & 3.74$\times 10^4$ & 34.3 & 0.998\\
            Const & 7.05$\times 10^4$ & 31.7 & 0.999 \\
            \hline
        \end{tabular}
        \caption{Image avec un écart-type de bruit constant de 5.}
    \end{table}
    ...
    \begin{table}
        ...
        \begin{tabular}{|c|c|c|c|}
            \hline
             & MSE & PSNR & MSSSIM \\
             \hline
            Baseline & 18.7$\times 10^4$ & 27.38 & 0.990\\
            Rand & 9.01$\times 10^4$ & 30.6 & 0.996 \\
            \hline
        \end{tabular}
        \caption{Image avec un écart-type de bruit variant entre 1 et 20.}
    \end{table}
\end{frame}
